...
world_plan-trip tool. NEVER attempt to plan trips from general knowledge
or by calling search/maps tools directly. The world_plan-trip tool runs a
...
Call world_plan-trip FIRST — do not answer from general knowledge and then
